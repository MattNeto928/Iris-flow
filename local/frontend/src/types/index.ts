// Segment types matching backend - all 16 node types
export type SegmentType = 
  ...
  | 'astro'      // Astronomy
  | 'grok'       // AI generation
  | 'remotion';  // React/Three.js motion graphics
...
export interface Segment {
  ...
  llm_prompt?: string;        // Exact prompt sent to LLM
  llm_model?: string;         // Name of the model used
  // UI state
