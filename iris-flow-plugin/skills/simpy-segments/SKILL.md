---
name: simpy-segments
description: This skill should be used when generating SimPy discrete event simulation visualization code for Iris-flow simpy segments, including queue theory (M/M/1, M/M/c), process flow animations, customer service simulations, manufacturing pipelines, and any discrete-event system visualized with matplotlib.
version: 1.0.0
---

# SimPy Segment Generation
