---
name: networkx-segments
description: This skill should be used when generating NetworkX graph algorithm visualization code for Iris-flow networkx segments, when animating BFS, DFS, Dijkstra, spanning trees, centrality, or any graph theory concept using networkx and matplotlib as PNG frame sequences.
version: 1.0.0
---

# NetworkX Segment Generation
