---
name: astro-segments
description: This skill should be used when generating astronomy visualization code for Iris-flow astro segments, including orbital mechanics, solar system animations, star field backgrounds, constellations, gravitational simulations, black holes, and any space/astronomy educational visualization using astropy and matplotlib.
version: 1.0.0
---

# Astro Segment Generation
