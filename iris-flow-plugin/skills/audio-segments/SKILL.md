---
name: audio-segments
description: This skill should be used when generating audio/signal visualization code for Iris-flow audio segments, including waveform animations, FFT frequency spectrum bars, spectrograms, harmonic decomposition, and signal processing educational visualizations using librosa and matplotlib.
version: 1.0.0
---
